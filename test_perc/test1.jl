...
function test_QSA_alt(;N::Integer = 1001, α::Real = 0.6, M::Integer = 32, alg = :rrr, τ::Integer = 10^2, seed = 78821000027346, tag::AbstractString = "", num_steps::Integer = 30,
...
function test_QSA_alt2(;N::Integer = 1001, α::Real = 0.6, M::Integer = 32, alg = :rrr, τ::Integer = 10^2, seed = 78821000027346, tag::AbstractString = "", num_steps::Integer = 30,
                       β::Float64 = 32.0, β1::Float64 = NaN, precool::Bool = true, Γ0::Float64 = 2.5, Γ1::Float64 = 1e-2)
    isnan(β1) && (β1 = β)
...
function test_QSA_alt3(;N::Integer = 1001, α::Real = 0.6, M::Integer = 32, alg = :rrr, τ::Integer = 10^2, seed = 78821000027346, tag::AbstractString = "", num_steps::Integer = 30,
                       β::Float64 = 32.0, β1::Float64 = NaN, precool::Bool = true, Γ0::Float64 = 2.5, Γ1::Float64 = 1e-2)
    isnan(β1) && (β1 = β)
...
function test_QSA_alt4(;N::Integer = 1001, α::Real = 0.6, M::Integer = 32, alg = :rrr, τ::Integer = 10^2, seed = 78821000027346, tag::AbstractString = "", num_steps::Integer = 30,
                       β::Float64 = 32.0, β1::Float64 = NaN, precool::Bool = true, Γ0::Float64 = 2.5, Γ1::Float64 = 1e-2)
    isnan(β1) && (β1 = β)
...
function C1_from_C_tr(C::RRRMC.Config, M::Integer, X::RRRMC.GraphRepl)
    N = C.N
    @assert N % M == 0
    Nk = N ÷ M
    C1 = RRRMC.Config(Nk)
