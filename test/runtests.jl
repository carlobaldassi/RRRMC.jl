...
function test()
    ...
    graphs = [
        ...
        RRRMC.GraphCommReLU(24, 6, 30),
        RRRMC.GraphCommReLU(22, 6, 30, fc=true),
        RRRMC.GraphCommQu(24, 6, 30),
        RRRMC.GraphCommQu(22, 6, 30, fc=true),
        ...
        RRRMC.GraphQCommReLUT(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphQCommReLUT(22, 6, 30, 5, 0.5, 2.0, fc=true),
        RRRMC.GraphQCommQuT(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphQCommQuT(22, 6, 30, 5, 0.5, 2.0, fc=true),
        ...
        RRRMC.GraphCommReLURE(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphCommReLURE(22, 6, 30, 5, 0.5, 2.0, fc=true),
        RRRMC.GraphCommQuRE(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphCommQuRE(22, 6, 30, 5, 0.5, 2.0, fc=true),
        ...
        RRRMC.GraphCommReLULE(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphCommReLULE(22, 6, 30, 5, 0.5, 2.0, fc=true),
        RRRMC.GraphCommQuLE(24, 6, 30, 5, 0.5, 2.0),
        RRRMC.GraphCommQuLE(22, 6, 30, 5, 0.5, 2.0, fc=true),
